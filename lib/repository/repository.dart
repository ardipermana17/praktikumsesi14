...
class Repository {
  Future<bool> checkSession(String sessionToken) async {
    ...
    try {
      ...
      final response = await _dio.post(
        'https://client-server-ardi.000webhostapp.com/session.php',
        data: fdata,
      );
  ...
  Future logout() async {
    ...
    final response = await _dio.post(
      'https://client-server-ardi.000webhostapp.com/logout.php',
      data: fdata,
    );
  ...
  Future login({required String username, required String password}) async {
    ...
    final response = await _dio.post(
      'https://client-server-ardi.000webhostapp.com/login.php',
      data: fdata,
    );
    log("res $response");
